...
mkdir updater\ref
echo %cd%
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\Installer\_First_Run_Installer.exe" "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\x64\Debug\net10.0-windows10.0.19041.0\_First_Run_Installer.exe"
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.exe" "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\x64\Debug\net10.0-windows10.0.19041.0\runas.exe"
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.dll" "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\x64\Debug\net10.0-windows10.0.19041.0\runas.dll"
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.runtimeconfig.json" "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\x64\Debug\net10.0-windows10.0.19041.0\runas.runtimeconfig.json"
endlocal
echo -----------------------------------
...
IF EXIST bin\x64\Release\net10.0-windows10.0.19041.0\updater GOTO end
...
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.exe" "runas.exe"
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.dll" "runas.dll"
copy /B /Y "%SolutionDir%\TcNo-Acc-Switcher-Client\bin\runas\x64\Release\net10.0\runas.runtimeconfig.json" "runas.runtimeconfig.json"
...
REN "net10.0-windows10.0.19041.0" "TcNo-Acc-Switcher"
